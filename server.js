...
// Serve static files → API has priority because it's defined later
...
server.get('/questions', (req, res) => {
  let orderBy = 'q.created_at DESC';  // default: newest first

  const sort = req.query.sort;
  if (sort === 'likes') {
    orderBy = 'q.votes DESC, q.created_at DESC';  // most liked first, then newest if tie
  } else if (sort === 'recent') {
    orderBy = 'q.created_at DESC';
  }
  // You can add more options later, e.g. 'oldest', 'least-liked', etc.
